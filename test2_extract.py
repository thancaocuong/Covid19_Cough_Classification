...
def init_dataset(csv_path, config=None, fold_idx=1, audio_folder=""):
    ...
    #* 65 thì phải bật cái này lên
    # val_audio_transform = Compose([
    #     Normalize(p = 1)
    # ])

    #* val còn lại thì bật cái này 
...
def main(config, fold_idx):
    ...
    checkpoint_path = '/media/sonnh/AICOVIDVN/saved1/models/63-Covid19-Eff_b7/checkpoint//checkpoint_{}_fold{}.pth'
    top_n_model = 10
    df = pd.read_csv('/media/sonnh/AICOVIDVN/saved1/models/63-Covid19-Eff_b7/checkpoint//result_fold{}.csv'.format(fold_idx))
    ...
    with open('/home/hana/sonnh/covidaivn/stack_feature/63/final_fold{}.pickle'.format(fold_idx), 'wb') as handle:
        pickle.dump(features, handle, protocol=pickle.HIGHEST_PROTOCOL)

    with open('/home/hana/sonnh/covidaivn/stack_feature/63/public_test_fold{}.pickle'.format(fold_idx), 'wb') as handle:
